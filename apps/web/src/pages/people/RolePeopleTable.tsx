...
import { SUPERVISOR_FILTERS, type SupervisorFilter, type SupervisorRow } from './rolePeopleModel.js';
...
export function RolePeopleTable({
  columns,
  rows,
  filter,
  onFilter,
  ...
  onFilter: (filter: SupervisorFilter) => void;
  query: string;
