  ...
  return (
    <MarketingLayout>
      <div className="mx-auto max-w-7xl px-4 pb-16 pt-[52px] sm:px-6">
        <span className="text-[12.5px] font-extrabold uppercase tracking-[0.12em] text-brand-deep">Resources</span>
            ...
            return (
              <article key={name} className="rounded-lg border border-neutral-200 bg-white p-5">
                ...
                <button
                  type="button"
                  onClick={() => setCat(name)}
                  className="mt-3 h-[38px] rounded-[10px] border border-neutral-200 bg-white px-[15px] text-sm font-bold text-neutral-700 transition-colors hover:border-brand-500"
                >
                  Browse
                </button>
              </article>
        ...
        <section className="mt-6.5 rounded-lg border border-dashed border-neutral-300 bg-[#FDFCFB] px-6 py-9 text-center">
          ...
          <Link
            to="/request-demo"
            className="mt-4.5 inline-flex h-[44px] items-center rounded-xl border border-neutral-200 bg-white px-5 text-base font-bold text-neutral-900 transition-colors hover:border-brand-500"
          >
            Talk to us
          </Link>
        </section>
