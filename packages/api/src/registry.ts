...
import {
  listMembers, listRoles, listInvitableRoles, listInvitations, inviteMember, revokeInvitation, resendInvitation,
  getRoleCapabilities, updateRolePermissions
} from './operations/membership.js';
...
export function createDefaultRegistry(): RpcRegistry {
  ...
  registry.register(getRoleCapabilities);
  registry.register(updateRolePermissions);
  ...
  registry.register(addShiftToEmployeeOnDate);
  ...
  registry.register(getScheduleConflicts);
  registry.register(findAdjacentSchedule);
  registry.register(duplicateScheduleShifts);
  registry.register(unpublishSchedule);
  registry.register(listScheduleDayOffs);
  registry.register(markDayOff);
  registry.register(clearDayOff);
