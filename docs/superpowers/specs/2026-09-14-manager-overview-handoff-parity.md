...
- The header's Manager/Supervisor/Staff and Populated/Loading/Empty tabs are prototype controls and are not rendered.
- Sidebar items are the handoff's Manager nav in its order — Overview, Schedules, Employees, Supervisors, Admins, Tasks, Recent Activity, Announcements, Requests, Reports, Settings — plus Attendance before Tasks (user decision, 2026-09-14). Branches, Members & Roles, Invitations, Organization and Admin Console are no longer in the nav. Supervisors, Admins, Recent Activity, Reports and Settings are "coming soon" pages (`pages/placeholder/ComingSoonPage.tsx`) that link to what already covers them (Invitations, Members & roles, Attendance, Profile, Organization, Security). Badges: Requests (waiting on your approval) and Supervisors (supervisor invitations outstanding).
- The Manager works in one branch — their home branch, the organization's oldest active branch (`useDefaultBranchId`) — and never sees or switches to another: the sidebar's Branch card only names it, and the branch pickers, `?branch=`, Branch columns and other-branch announcement audiences are gone from the overview, Schedules, Import Employees, Tasks, Attendance, Employees, the employee form, Invitations and Announcements.
